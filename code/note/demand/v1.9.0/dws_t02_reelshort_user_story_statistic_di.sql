drop Table if  exists dws_data.dws_t02_reelshort_user_story_statistic_di;
Create Table if not exists dws_data.dws_t02_reelshort_user_story_statistic_di(
...
delete from dws_data.dws_t02_reelshort_user_story_statistic_di where analysis_date='${TX_DATE}';
insert into dws_data.dws_t02_reelshort_user_story_statistic_di
select
      null           as id                  -- 自增id
