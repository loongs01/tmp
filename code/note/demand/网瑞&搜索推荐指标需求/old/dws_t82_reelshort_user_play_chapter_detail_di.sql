...
select 
	...
	-- add by lcz
	,cast(sum(t1.trans_start_amt) as decimal(18,4))               as trans_start_amt -- 拉起支付sdk开始支付金额
	...
	,coalesce(t4.book_type,-999)                                    as book_type -- 书籍类型
from 
(
	select
		coalesce(t1.id ,t2.id,t4.id,t5.id ,t6.id ,t7.id ,t8.id ,t9.id,t10.id,t11.id,t12.id) as id 
		,coalesce(t1.uuid,t2.uuid,t4.uuid,t5.uuid ,t6.uuid ,t7.uuid ,t8.uuid ,t9.uuid,t10.uuid ,t11.uuid,t12.uuid) as uuid 
		,coalesce(t1.analysis_date,t2.analysis_date,t4.analysis_date,t5.analysis_date,t6.analysis_date,t7.analysis_date,t8.analysis_date,t9.analysis_date,t10.analysis_date,t11.analysis_date,t12.analysis_date) as analysis_date
		,coalesce(t1.etl_date ,t2.etl_date,t4.etl_date,t5.etl_date,t6.etl_date,t7.etl_date,t8.etl_date,t9.etl_date,t10.etl_date,t11.etl_date,t12.etl_date) as etl_date
		,coalesce(t1.country_id,t2.country_id,t4.country_id,t5.country_id ,t6.country_id ,t7.country_id ,t8.country_id ,t9.country_id,t10.country_id ,t11.country_id,t12.country_id) as country_id 
		,coalesce(t1.channel_id,t2.channel_id,t4.channel_id,t5.channel_id ,t6.channel_id ,t7.channel_id ,t8.channel_id ,t9.channel_id,t10.channel_id ,t11.channel_id,t12.channel_id) as channel_id 
		,coalesce(t1.version,t2.version,t4.version,t5.version ,t6.version ,t7.version ,t8.version ,t9.version,t10.version ,t11.version,t12.version) as version 
		,coalesce(t1.cversion,t2.cversion,t4.cversion,t5.cversion ,t6.cversion ,t7.cversion ,t8.cversion ,t9.cversion,t10.cversion ,t11.cversion,t12.cversion) as cversion 
		,coalesce(t1.res_version,t2.res_version,t4.res_version,t5.res_version ,t6.res_version ,t7.res_version ,t8.res_version ,t9.res_version,t10.res_version ,t11.res_version,t12.res_version) as res_version 
		,coalesce(t1.language_id,t2.language_id,t4.language_id,t5.language_id ,t6.language_id ,t7.language_id ,t8.language_id ,t9.language_id,t10.language_id ,t11.language_id,t12.language_id) as language_id 
		,coalesce(t1.platform,t2.platform,t4.platform,t5.platform ,t6.platform ,t7.platform ,t8.platform ,t9.platform,t10.platform ,t11.platform,t12.platform) as platform 
		,coalesce(t1.os_version,t2.os_version,t4.os_version,t5.os_version ,t6.os_version ,t7.os_version ,t8.os_version ,t9.os_version,t10.os_version ,t11.os_version,t12.os_version) as os_version 
		,coalesce(t1.device_id,t2.device_id,t4.device_id,t5.device_id ,t6.device_id ,t7.device_id ,t8.device_id ,t9.device_id,t10.device_id ,t11.device_id,t12.device_id) as device_id 
		,coalesce(t1.ad_id,t2.ad_id,t4.ad_id,t5.ad_id ,t6.ad_id ,t7.ad_id ,t8.ad_id ,t9.ad_id,t10.ad_id ,t11.ad_id,t12.ad_id) as ad_id 
		,coalesce(t1.story_id,t2.story_id,t4.story_id,t5.story_id,t6.story_id,t7.story_id,t8.story_id ,t9.story_id,t10.story_id,t11.story_id,t12.story_id) as story_id
		,coalesce(t1.chap_id,t2.chap_id,t4.chap_id,t5.chap_id,t6.chap_id,t7.chap_id,t8.chap_id ,t9.chap_id,t10.chap_id,t11.chap_id,t12.chap_id) as chap_id
		,coalesce(t1.chap_order_id,t2.chap_order_id,t4.chap_order_id,t5.chap_order_id,t6.chap_order_id,t7.chap_order_id,t8.chap_order_id ,t9.chap_order_id,t10.chap_order_id,t11.chap_order_id,t12.chap_order_id) as chap_order_id
		,coalesce(t1.t_book_id,t2.t_book_id,t4.t_book_id,t5.t_book_id,t6.t_book_id,t7.t_book_id,t9.t_book_id,t10.t_book_id,t12.t_book_id,'') as t_book_id 
		,t1.is_free
		...
		,coalesce(t12.trans_start_amt,0) as trans_start_amt -- 拉起支付sdk开始支付金额
    from 
    (
		select
			min(id) as id
...
-- add by lcz 增加trans_start_amt -- 拉起支付sdk开始支付金额
  full join 
    (
        select 
              min(id) as id
    ...
    on t1.uuid=t12.uuid and t1.analysis_date=t12.analysis_date and t1.story_id=t12.story_id 
    and t1.chap_id=t12.chap_id and t1.chap_order_id=t12.chap_order_id
    and t1.country_id=t12.country_id
    and t1.channel_id=t12.channel_id
    and t1.version=t12.version
    and t1.cversion=t12.cversion
    and t1.res_version=t12.res_version
    and t1.language_id=t12.language_id
    and t1.platform=t12.platform
    and t1.os_version=t12.os_version
    and t1.device_id=t12.device_id
    and t1.ad_id=t12.ad_id
    and t1.t_book_id=t12.t_book_id
) t1 
...
group by t1.uuid 
      ...
      ,coalesce(t2.recent_visit_source,'')
      ,coalesce(t2.recent_visit_source_type,'')
      ,coalesce(t3.first_visit_landing_page,'')
      ,coalesce(t3.first_visit_landing_page_story_id,'')
      ,coalesce(t3.first_visit_landing_page_chap_id,'')
      ,coalesce(t4.book_type,-999)
;
