...
REFRESH MATERIALIZED VIEW dw_view.mtv_dws_t80_reelshort_user_bhv_cnt_detail_di_temp;
...
select id
       ...
       ,dlink_story_id
       -- add by lcz
      -- ,trans_complete_amt -- 订单支付金额
       ,trans_start_amt -- 拉起支付sdk开始支付金额
...
where etl_date < date_sub(CURRENT_DATE,1)
      and uuid regexp '^[0-9]+$'
      and uuid<2147483647
union all 
select *
