...
/*+ cte_execution_mode=shared */
insert into  dwd_data.dwd_t04_reelshort_opc_push_detail_di
with reelshort_push_stat as (select *
                             from dwd_data.dwd_t02_reelshort_push_stat_di
...
(
    ...
    group by analysis_date,uuid,run_id,fcm_message_id,platform,country_id,language_id,version,sub_event_name
) t1
left join (
  select uuid
      ,platform
