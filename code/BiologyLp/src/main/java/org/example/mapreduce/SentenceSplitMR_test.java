...
public class SentenceSplitMR_test {
        ...
        protected void map(LongWritable key, Text value, Context context)
            ...
            if (lastEnd < text.length()) {
                ...
                if (!lastSentence.isEmpty()) {
                    ...
                    processedSentences.add(lastSentence + "X"); // 添加空格作为结尾标点
                }
            }
            ...
            for (int i = 0; i < processedSentences.size(); i++) {
                ...
                String sentInfo = String.format("%d\t%s\t%s\t%s",
                        i, sent, sentMd5,
                        sent.isEmpty() ? " " : sent.substring(sent.length() - 1));
...
//                System.out.println(output);
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(SentenceSplitMR_test.class);
