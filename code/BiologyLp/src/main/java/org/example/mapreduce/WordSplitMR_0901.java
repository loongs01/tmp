...
//                        List<SimpleWord> wordList = simpleSegment(sentText);
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(WordSplitMR_0901.class);
        job.setMapperClass(WordSplitMR_0901.WordSplitMapper.class);
        job.setReducerClass(WordSplitMR_0901.WordSplitReducer.class);
